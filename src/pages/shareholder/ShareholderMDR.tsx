              ...
              <Table>
                <TableHeader>
                  <TableRow className="bg-muted/50 hover:bg-muted/50">
                    ...
                    <TableHead className="text-right border-r bg-cyan-100 dark:bg-cyan-950/20 text-cyan-900 dark:text-cyan-400 font-semibold">
                      Shareholder %
                    </TableHead>
                    ...
                    clientMDRData.map((row, index) => (
                      <TableRow key={index} className="hover:bg-blue-50/30 dark:hover:bg-slate-900/50">
                        ...
                        <TableCell className="text-right bg-white dark:bg-cyan-950/20 border-r font-medium">
                          <Badge variant="outline" className="bg-cyan-100 dark:bg-cyan-950/20 text-cyan-700 dark:text-cyan-400">
                        ...
                        <TableCell className="text-right bg-white dark:bg-cyan-950/20 border-r text-cyan-700 dark:text-cyan-400 font-bold">
