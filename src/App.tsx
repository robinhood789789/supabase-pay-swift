...
function AppContent() {
  ...
  return (
    <Routes>
      ...
      />
      <Route
        path="/settings/mfa-troubleshooting"
        element={
          <ProtectedRoute>
            <MfaTroubleshooting />
          </ProtectedRoute>
      ...
      <Route path="/admin/incoming-transactions" element={<SuperAdminRoute><PlatformLayout><IncomingTransactions /></PlatformLayout></SuperAdminRoute>} />
      <Route
        path="/admin/users"
        element={
          <ProtectedRoute>
