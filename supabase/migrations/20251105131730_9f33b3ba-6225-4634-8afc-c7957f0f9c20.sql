-- Seed Data: ข้อมูลตัวอย่างธุรกรรมเพื่อทดสอบระบบ (แก้ไขชื่อ column)
...
BEGIN
  ...
  -- ธุรกรรมตัวอย่าง: DEPOSIT, WITHDRAWAL, TRANSFER
  ...
  -- TRANSFER (โอนระหว่าง owner) - ต้องมี 2 แถว
  ...
  VALUES (
    sample_tenant_id, sample_creator_id,
    'SEED_DATA_CREATED', 'transactions',
    jsonb_build_object(
  ...
  RAISE NOTICE 'Wallet balance should be updated automatically via triggers';
END $$;